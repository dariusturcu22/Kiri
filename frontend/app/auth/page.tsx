...
// Derive the backend URL from the current hostname so mobile on LAN works.
// Backend always runs on port 5046 HTTP.
function getBackendUrl() {
  if (typeof window === "undefined") return "http://localhost:5046";
  return `${window.location.protocol}//${window.location.hostname}:5046`;
}
