  ...
  return (
    <div className="flex min-h-screen bg-[#FAF7F2] font-sans">
      ...
      <main className="flex-1 flex flex-col min-w-0">
        <header className="bg-white border-b border-[#EDE8DF] px-8 h-16 flex items-center gap-3 shrink-0">
          <ShieldAlert className="w-5 h-5 text-[#3A5230]" />
          <h1 className="text-2xl font-extrabold text-[#1E1208]">Admin Panel</h1>
        </header>
